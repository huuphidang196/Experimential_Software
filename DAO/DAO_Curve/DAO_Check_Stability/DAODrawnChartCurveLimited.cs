...
{
    public class DAODrawnChartCurveLimited
    {
        private static DAODrawnChartCurveLimited _instance;
        public static DAODrawnChartCurveLimited Instance
        {
            get { if (_instance == null) _instance = new DAODrawnChartCurveLimited(); return _instance; }
            private set { }
        }

        private DAODrawnChartCurveLimited() { }
        ...
        {
            ConnectableE ePower_load = DAOCalculateQLJStepOne.Instance.GetEPowerPLoadFromEPowerBusLoadConsider(busLoadExamined);

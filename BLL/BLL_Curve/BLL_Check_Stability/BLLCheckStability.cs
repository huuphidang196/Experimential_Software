...
{
    public class BLLCheckStability
    {
        private static BLLCheckStability _instance;
        public static BLLCheckStability Instance
        {
            get { if (_instance == null) _instance = new BLLCheckStability(); return _instance; }
            private set { }
        }

        private BLLCheckStability() { }

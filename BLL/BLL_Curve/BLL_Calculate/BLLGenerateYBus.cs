...
{
    public class BLLGenerateYBus
    {
        private static BLLGenerateYBus _instance;
        public static BLLGenerateYBus Instance
        {
            get { if (_instance == null) _instance = new BLLGenerateYBus(); return _instance; }
            private set { }
        }

        private BLLGenerateYBus() { }

...
namespace Experimential_Software.BLL.BLL_Curve.BLL_Calculate
{
    ...
    public class BLLGenerateListPoints
    {
        private static BLLGenerateListPoints _instance;
        public static BLLGenerateListPoints Instance
        {
            get { if (_instance == null) _instance = new BLLGenerateListPoints(); return _instance; }
            private set { }
        }
        private BLLGenerateListPoints() { }
        ...
        public virtual List<PowerSystem> GenerateListPointStabilityLimitCurve(List<ConnectableE> AllEPowers, ConnectableE EPowerBusJLoad)
        {
            ...
            ConnectableE ELoad = DAOGetDataOfEPower.Instance.GetEPowerPLoadFromEPowerBusLoadConsider(EPowerBusJLoad);
        ...
        public virtual void SendDataBeforeCalculate(List<ConnectableE> AllEPowers, ConnectableE EPowerBusJLoad)
        {
            ...
            BLLCalculateQLJStepOne.Instance.SetDatabaseOriginBeforeCalculate(dtoDataInputPS, allBus, EPowerBusJLoad);
        }
        //Overall Form Isoval use
        ...
        {
            double QLj_Run = BLLCalculateQLJStepOne.Instance.GetQLjSuitableForStablePower(P_LjRun);
            return QLj_Run;
        }
    }
}
